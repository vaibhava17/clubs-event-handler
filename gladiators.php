          ...
          <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <form role="form" action="gladiatorsvacant.php" method="POST" enctype="multipart/form-data" onsubmit="myFunction()">
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control form2" name="email" placeholder="Enter Enmail ID" style="background-color: white;">
                    </div>
                    <div class="form-group">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header">
                <img src="ADMIN/<?php echo $final['image']; ?>" alt="gladiators" />
              </div>
              <div class="card-body">
                <h2>
                  <?php echo $final['name'] ?>
                ...
                <div class="row">
                  <div class="col"> <a href="Admin/<?php if ($final['filename'] == true) {
                                                    ...
                                                    } ?> "><button class="btn btn-success">Read More</button></a></div>
                  <div class="col">
                    <div class="container">
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#enroll">
                        Enroll Now
                      </button>
                    </div>
                  </div>
    ...
    <div class="modal fade" id="enroll" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <form role="form" action="gladiatorsenroll.php" method="POST" enctype="multipart/form-data" onsubmit="myFunction()">
            <div class="modal-body">
              <div class="form-group">
                <label>Full name</label>
                <input type="text" class="form-control form2" name="name" aria-describedby="emailHelp" placeholder="Enter Full Name" style="background-color: white;">
