          ...
          <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <form role="form" action="gizmofreaksvacant.php" method="POST" enctype="multipart/form-data" onsubmit="myFunction()">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col"> <a href="Admin/<?php if ($final['filename'] == true) {
                                                    ...
                                                    } ?> "><button class="btn btn-secondary">Read More</button></a></div>
                  <div class="col">
                    <div class="container">
    ...
    <div class="modal fade" id="enroll" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <form role="form" action="gizmofreaksenroll.php" method="POST" enctype="multipart/form-data" onsubmit="myFunction()">
            <div class="modal-body">
              <div class="form-group">
                <label>Full name</label>
                <input type="text" class="form-control form2" name="name" aria-describedby="emailHelp" placeholder="Enter Full Name" style="background-color: white;">
