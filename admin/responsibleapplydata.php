...
if(isset($_SESSION['role']) && $_SESSION['role']!='responsible' && $_SESSION['role']!='admin'){
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">The Responsible Invertian Club Applications</h5>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    $sql="SELECT * from applyresponsible";
